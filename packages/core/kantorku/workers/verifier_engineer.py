...
class VerifierEngineer(BaseWorker):
    async def handle(self, task: Task) -> TaskResult:
        ...
        context_parts = [
            f"Review the following output for engineering quality:\n\n"
        ...
        prompt = "\n\n".join(context_parts)
        prompt += "\n\nCheck for logic errors, security issues, test coverage, and code quality. Respond with JSON containing issues (list), approved (bool), and suggestions (list)."
