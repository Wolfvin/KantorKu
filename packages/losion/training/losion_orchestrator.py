...
from kantorku.losion.config import LosionConfig, DAPOConfig, RLVRConfig, JEPAConfig
...
class LosionTrainingOrchestrator:
    ...
    **Phase 4 — Advanced Optimization (90-100%)**
    ...
    def _init_jepa(self) -> None:
        ...
        try:
            from kantorku.losion.training.llm_jepa import LLMJEPA, JEPAConfig as JepaCfg
    ...
    def _init_rl_trainer(self) -> None:
        ...
        if self.config.use_dapo:
            try:
                from kantorku.losion.training.dapo import DAPOTrainer, DAPOConfig as DapoCfg
        ...
        # Fallback: GRPO
        try:
            from kantorku.losion.training.grpo import GRPOTrainer, GRPOConfig
    ...
    def _init_rlvr(self) -> None:
        ...
        try:
            from kantorku.losion.training.rlvr import (
                RLVRTrainer,
    ...
    def _init_etr(self) -> None:
        ...
        try:
            from kantorku.losion.training.etr_reward import ETRTrainer, ETRConfig
    ...
    def _init_bit_distill(self) -> None:
        ...
        try:
            from kantorku.losion.core.quantization.bit_distill import (
                BitDistillTrainer,
                BitDistillConfig,
            )
    ...
    def _init_active_learning(self) -> None:
        ...
        try:
            from kantorku.losion.training.active_learning import (
                ActiveLearningLoop,
    ...
    def _init_evolutionary(self) -> None:
        ...
        try:
            from kantorku.losion.training.evolutionary_search import (
