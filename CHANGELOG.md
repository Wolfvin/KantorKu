...
### P4.1: Open-Source Readiness & Type Safety

#### Framework
- **Removed**: `ignoreBuildErrors: true` from `next.config.ts`
- **Changed**: Enabled `noImplicitAny: true` in `tsconfig.json`
- **Security**: Replaced `dangerouslySetInnerHTML` with `react-markdown` for XSS safety
- **Added**: Missing type definitions (`AggregatedHealth`, `HealthDashboard`, `OfficeStatus`, `CircuitBreakerStatus`, `SessionSnapshot`, `CacheEntry`, `WorkerApiKeyConfig`, `UndoableAction`)
- **Added**: Per-worker API key configuration in store
- **Added**: Undo/redo support for contract actions
- **Added**: Cache management in store
- **Added**: Critical priority support in `TaskQueuePanel`
- **Fixed**: All TypeScript strict mode errors
- **Added**: Open-source infrastructure (README, LICENSE, CONTRIBUTING, CREDITS, etc.)
...
[0.4.1]: https://github.com/Wolfvin/KantorKu/releases/tag/v0.4.1
[0.4.0]: https://github.com/Wolfvin/KantorKu/releases/tag/v0.4.0
[0.3.0]: https://github.com/Wolfvin/KantorKu/releases/tag/v0.3.0
[0.2.0]: https://github.com/Wolfvin/KantorKu/releases/tag/v0.2.0
