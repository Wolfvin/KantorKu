...
from kantorku.losion.models.shared import RMSNorm, WeightInitMixin
...
class LosionModel(nn.Module, WeightInitMixin):
    ...
    Uses WeightInitMixin from kantorku.losion.models.shared for standardized
    ...
    # _init_weights is provided by WeightInitMixin (from kantorku.losion.models.shared)
