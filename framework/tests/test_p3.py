...
class TestAtomicWrites:
    ...
    def test_atomic_write_creates_file(self, tmp_path):
        from kantorku.interface.persistence import atomic_write
    ...
    def test_atomic_write_json(self, tmp_path):
        from kantorku.interface.persistence import atomic_write_json
        path = tmp_path / "test.json"
    ...
    def test_atomic_read_json(self, tmp_path):
        from kantorku.interface.persistence import atomic_write_json, atomic_read_json
        path = tmp_path / "test.json"
    ...
    def test_atomic_read_json_missing_file(self, tmp_path):
        from kantorku.interface.persistence import atomic_read_json
...
class TestSessionSnapshot:
    ...
    def test_snapshot_to_dict(self):
        from kantorku.interface.persistence import SessionSnapshot
...
class TestOfficeSnapshot:
    ...
    def test_office_snapshot_round_trip(self):
        from kantorku.interface.persistence import OfficeSnapshot, SessionSnapshot
        snap = OfficeSnapshot(
            sessions={
...
class TestCrashRecovery:
    ...
    def test_recover_from_snapshot(self, tmp_path):
        from kantorku.interface.persistence import CrashRecovery, CheckpointManager, atomic_write_json
